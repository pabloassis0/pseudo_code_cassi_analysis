...
} // compare this list with all ocorrences at our database, to double check the price


return object //this can be empty, in case all the registry on the cassi_spreadsheet exists on our database
